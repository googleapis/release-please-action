...
|         `changelog-types`          | A JSON formatted String containing to override the outputted changelog sections. All non-hidden types will be treated as patch versions minimum.                                                                                                                                                                                                                                                                                |
