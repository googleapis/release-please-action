...
## [5.0.0](https://github.com/googleapis/release-please-action/compare/v4.1.1...v5.0.0) (2024-05-14)
...
* **release-please:** consolidate manifest and individual releasers ([#398](https://github.com/googleapis/release-please-action/issues/398))

### Features

* add `bump-patch-for-minor-pre-major` option ([#365](https://github.com/googleapis/release-please-action/issues/365)) ([435e216](https://github.com/googleapis/release-please-action/commit/435e216fbed0bacec7eb7bc92d39191c3b2c2c3a))
...
* Add a changelog section type ([#64](https://github.com/googleapis/release-please-action/issues/64)) ([2ca6d30](https://github.com/googleapis/release-please-action/commit/2ca6d30396e3b6b10ca9623ecbc3174b476ec8a2))
* add additional outputs ([#106](https://github.com/googleapis/release-please-action/issues/106)) ([c0f7d24](https://github.com/googleapis/release-please-action/commit/c0f7d24cd04488b7e14836d90143850b97aefadd))
...
* add pull-request-title-pattern option ([#259](https://github.com/googleapis/release-please-action/issues/259)) ([d447fdb](https://github.com/googleapis/release-please-action/commit/d447fdb6322f194c2dd23e2d39c8bd419e3d8ab6))
* add release_created per path in manifest PR ([#310](https://github.com/googleapis/release-please-action/issues/310)) ([5f94ede](https://github.com/googleapis/release-please-action/commit/5f94ededed7a7a441d1c47eca064ec7aeda117ec))
* add support for simple php projects ([#344](https://github.com/googleapis/release-please-action/issues/344)) ([d6f40e4](https://github.com/googleapis/release-please-action/commit/d6f40e4317daf6906456fefc0d4c081dfe03b51d))
* adds elixir support ([#354](https://github.com/googleapis/release-please-action/issues/354)) ([59f4915](https://github.com/googleapis/release-please-action/commit/59f49151772e19ad5a5c7959831ce4252f538789))
...
* allow changelogPath to be specified ([#153](https://github.com/googleapis/release-please-action/issues/153)) ([10d7619](https://github.com/googleapis/release-please-action/commit/10d761994342597b3e1d24464a41d28d5d97abe3))
* allow github-release/release-pr to be run separately ([#70](https://github.com/googleapis/release-please-action/issues/70)) ([37d423f](https://github.com/googleapis/release-please-action/commit/37d423feba66be7be541aa122419aee5b50fdf98))
* allow repo url to be set as argument to GitHub action ([#380](https://github.com/googleapis/release-please-action/issues/380)) ([a0cd0f5](https://github.com/googleapis/release-please-action/commit/a0cd0f5123ff8cb3d8e4aefd3158a4276c2034ed))
* **deps:** latest version of release-please ([#122](https://github.com/googleapis/release-please-action/issues/122)) ([5469575](https://github.com/googleapis/release-please-action/commit/54695753296b6274758664da88a333e49528635a))
* **deps:** release-please with support for alternate release branches ([#79](https://github.com/googleapis/release-please-action/issues/79)) ([dfe6b62](https://github.com/googleapis/release-please-action/commit/dfe6b622584ce774821ae93012eda87a2ad9d8a5))
* **deps:** release-please with support for alternate release branches ([#79](https://github.com/googleapis/release-please-action/issues/79)) ([14b9b0f](https://github.com/googleapis/release-please-action/commit/14b9b0f74a45f15a3c90302c3071e419c2d9fa78))
...
* **deps:** upgrade to release-please 6.7.0 ([#95](https://github.com/googleapis/release-please-action/issues/95)) ([6461ef3](https://github.com/googleapis/release-please-action/commit/6461ef332678b2989b09860f8d6b0652cd7a8432))
* **deps:** upgrade to release-please 6.9.0 ([#100](https://github.com/googleapis/release-please-action/issues/100)) ([40aba5e](https://github.com/googleapis/release-please-action/commit/40aba5e11684d69de9f36e60e19de0c5aa28750b))
* **input:** add github API URL configuration for input ([#368](https://github.com/googleapis/release-please-action/issues/368)) ([fd7f2ff](https://github.com/googleapis/release-please-action/commit/fd7f2fff26a5ad2654f5f5dc574fd7818f46daec))
* **input:** add github GraphQL URL configuration for input ([#385](https://github.com/googleapis/release-please-action/issues/385)) ([720c5f8](https://github.com/googleapis/release-please-action/commit/720c5f8f53b8b3ef01ade67dd0ac1a3a8296791d))
* manifest based releaser https://git.io/JmVD4 ([#273](https://github.com/googleapis/release-please-action/issues/273)) ([45c32cc](https://github.com/googleapis/release-please-action/commit/45c32ccd248469ba2567c6dfd45c3c4cd2a241b4))
* **manifest:** add manifest-pr command ([#280](https://github.com/googleapis/release-please-action/issues/280)) ([f48a175](https://github.com/googleapis/release-please-action/commit/f48a175f37213946490a27038ecf023326e09fb6))
* output list of paths released during manifest release ([#362](https://github.com/googleapis/release-please-action/issues/362)) ([670afac](https://github.com/googleapis/release-please-action/commit/670afac8ab682e158b4e390a3209d42346e72518))
* pass monorepoTags and packageName when creating GitHub release ([#112](https://github.com/googleapis/release-please-action/issues/112)) ([69af5fc](https://github.com/googleapis/release-please-action/commit/69af5fc7d9bb0977586102a0e1488abab7fdaace))
...
* **release-please:** add default branch input option ([#202](https://github.com/googleapis/release-please-action/issues/202)) ([4845e49](https://github.com/googleapis/release-please-action/commit/4845e49098adfa5e7b79838e06aaf281778e9545))
* **release-please:** add default branch input option for github release ([#206](https://github.com/googleapis/release-please-action/issues/206)) ([534536c](https://github.com/googleapis/release-please-action/commit/534536c1c22bf1b590511b1ab65c732a67439212))
* **release-please:** add default token input option ([#212](https://github.com/googleapis/release-please-action/issues/212)) ([eea7db7](https://github.com/googleapis/release-please-action/commit/eea7db7fda9e26271d7bcd313f760e7443fee321))
* **release-please:** add signoff options to sign off commits ([#374](https://github.com/googleapis/release-please-action/issues/374)) ([7677480](https://github.com/googleapis/release-please-action/commit/76774804a87fc57538dd196466b0f6898a3a69de))
* **release-please:** add support for ocaml ([#189](https://github.com/googleapis/release-please-action/issues/189)) ([c1aca05](https://github.com/googleapis/release-please-action/commit/c1aca052417abd8c2b0d1e68ce826282ae3b245a))
* **release-please:** add support for Rust ([#177](https://github.com/googleapis/release-please-action/issues/177)) ([fce09f2](https://github.com/googleapis/release-please-action/commit/fce09f2994e8c6711169af3c92fdfda15fa30f05))
...
* **release-please:** fallback tag check is looser ([#169](https://github.com/googleapis/release-please-action/issues/169)) ([46292e5](https://github.com/googleapis/release-please-action/commit/46292e55636f49995766fb1bb9ef1b0aaaf21aa7))
* **release-please:** improved go release strategy ([#301](https://github.com/googleapis/release-please-action/issues/301)) ([0267b45](https://github.com/googleapis/release-please-action/commit/0267b45516a836f3d70c32fc0b70036b1ef84eed))
* **release-please:** now supports large files; introduces fork option ([#67](https://github.com/googleapis/release-please-action/issues/67)) ([e7d31db](https://github.com/googleapis/release-please-action/commit/e7d31db9262f11895e7938b84f049e2d6a31be4f))
* **release-please:** update of release-please ([#298](https://github.com/googleapis/release-please-action/issues/298)) ([5a49a61](https://github.com/googleapis/release-please-action/commit/5a49a61eb57b1aa3c977a90dedc86e7161ce2a58))
* **release-please:** update to release-please 11.8.0 ([#289](https://github.com/googleapis/release-please-action/issues/289)) ([cb319a9](https://github.com/googleapis/release-please-action/commit/cb319a998f09574d2e228c1a23dfd46830dd29ce))
* **release-please:** update to release-please with manifest support ([#274](https://github.com/googleapis/release-please-action/issues/274)) ([82a3c7e](https://github.com/googleapis/release-please-action/commit/82a3c7ec92032e3d6774e37a95badf4ff1e89eec))
* **release-please:** update to release-please with rust mono-repo support ([#327](https://github.com/googleapis/release-please-action/issues/327)) ([4140ff7](https://github.com/googleapis/release-please-action/commit/4140ff739454a552bc374b97833ba8487a907c76))
* **release-please:** update to v11.0.0 of release please ([#250](https://github.com/googleapis/release-please-action/issues/250)) ([d7ed0b8](https://github.com/googleapis/release-please-action/commit/d7ed0b8f09544ebc80152b2f8b1b4736d2cb9b9b))
* **release-please:** upgrade release-please ([#269](https://github.com/googleapis/release-please-action/issues/269)) ([f92bb7e](https://github.com/googleapis/release-please-action/commit/f92bb7ea357f580e57bded5eede672f7778da56e))
* **release-please:** upgrade to release-please v11.4.0 ([#277](https://github.com/googleapis/release-please-action/issues/277)) ([80ebc45](https://github.com/googleapis/release-please-action/commit/80ebc4526172e282083faba234ebde7b3c3d6276))
* **release-please:** upgrade to release-please@11.11.0 ([#305](https://github.com/googleapis/release-please-action/issues/305)) ([48a8af5](https://github.com/googleapis/release-please-action/commit/48a8af5a36a420b485e8ed31a58edfea61270446))
* **release-please:** upgrade to relese-please with go support ([#133](https://github.com/googleapis/release-please-action/issues/133)) ([5703b0f](https://github.com/googleapis/release-please-action/commit/5703b0fdec00d70d4be84f7d1a98b3e5adb738ec))
* **release-please:** use latest release please version ([#210](https://github.com/googleapis/release-please-action/issues/210)) ([484099d](https://github.com/googleapis/release-please-action/commit/484099d9695e3107b5d0bab3f953ab900f69f9d8))
...
* `Unexpected input(s)` warning for inputs: `config-file` & `manifest-file` ([#356](https://github.com/googleapis/release-please-action/issues/356)) ([f19ddf2](https://github.com/googleapis/release-please-action/commit/f19ddf2fe64b11510b2a743ecb73af5bb693d79d))
* **build:** action with support for PHP ([fd790a2](https://github.com/googleapis/release-please-action/commit/fd790a278caa544313600a3eb908e5ebaecc6cc5))
* **build:** add message to tag ([b467439](https://github.com/googleapis/release-please-action/commit/b46743913ea2c717e2a144864cd026c3f2df4029))
* **build:** attempt to ignore errors ([15d0718](https://github.com/googleapis/release-please-action/commit/15d0718b84b06b34d9125a5d7e97b38888480f99))
* **build:** configure git checkout step ([ff5dfe1](https://github.com/googleapis/release-please-action/commit/ff5dfe1653289b33b5fb3e5de72e0b3733ff390d))
* **build:** document working version of release-please ([60ae28e](https://github.com/googleapis/release-please-action/commit/60ae28e4b20929fc93a249186726c13098fd6019))
* **build:** release from fork ([f2bda04](https://github.com/googleapis/release-please-action/commit/f2bda04bb55ac6fdaf5e3673a78323966a3768b5))
* **build:** revert build to non-debug form ([e6f39a1](https://github.com/googleapis/release-please-action/commit/e6f39a1ff2137720a77acef0b92a813658920fa4))
* **build:** run latest dist ([799e6de](https://github.com/googleapis/release-please-action/commit/799e6de570879ef6ad3d7067295b3e0c2c837e04))
* **build:** use new release strategy ([646de90](https://github.com/googleapis/release-please-action/commit/646de90a87173de7b76c7d83807348c2b05b3e43))
* **build:** working on version of build that tags major/minor release line ([d4814fe](https://github.com/googleapis/release-please-action/commit/d4814feca529141f25d8c871b3c2d093b38c14c8))
...
* bump release-please from 15.11.0 to 15.12.0 ([#790](https://github.com/googleapis/release-please-action/issues/790)) ([21e064e](https://github.com/googleapis/release-please-action/commit/21e064e1c6b5ff47fd786e6ace618d1ccf2a2bf9))
...
* **config:** add apiUrl config on Github release command ([#379](https://github.com/googleapis/release-please-action/issues/379)) ([906f915](https://github.com/googleapis/release-please-action/commit/906f9156f8d5659aa73c8cc6c4aea2c65cde2be2))
* **config:** packageName is optional ([#239](https://github.com/googleapis/release-please-action/issues/239)) ([df8698c](https://github.com/googleapis/release-please-action/commit/df8698c999dd72a46a62b8421c1d20eaba363488))
...
* default changelog sections to undefined ([31e1a25](https://github.com/googleapis/release-please-action/commit/31e1a25ccf4f8df92fdb4066e3650a6167e5fe25))
...
* **deps:** bump @actions/core from 1.2.4 to 1.2.6 ([#76](https://github.com/googleapis/release-please-action/issues/76)) ([fa86b83](https://github.com/googleapis/release-please-action/commit/fa86b83b5666ef0319c5508ded6b43af2cdf317b))
...
* do not set PR output, if no PR opened ([#129](https://github.com/googleapis/release-please-action/issues/129)) ([b0faf1d](https://github.com/googleapis/release-please-action/commit/b0faf1dd7d65697a12321df74e57458262513d70))
* do not try to fork ([#62](https://github.com/googleapis/release-please-action/issues/62)) ([139a5ef](https://github.com/googleapis/release-please-action/commit/139a5efd7c7e8161ddaa5d5f0f3a80be2e2af96a))
* **docs:** document functional version of release-please ([0ab3b32](https://github.com/googleapis/release-please-action/commit/0ab3b3257c9f07aa7e7f2ef5b843556b277b53f5))
* **docs:** indicate correct version ([#84](https://github.com/googleapis/release-please-action/issues/84)) ([b632af4](https://github.com/googleapis/release-please-action/commit/b632af41016a545a6e7ee6ecd9b9325538c88e28))
* fix readme typo ([#125](https://github.com/googleapis/release-please-action/issues/125)) ([d5b0c35](https://github.com/googleapis/release-please-action/commit/d5b0c3523e4cae31bc0a75685616e21df3197a90))
* fix workflow env missing bug ([#238](https://github.com/googleapis/release-please-action/issues/238)) ([0d18e74](https://github.com/googleapis/release-please-action/commit/0d18e7461f484869df6b9b604019d73f24291e9a)), closes [#237](https://github.com/googleapis/release-please-action/issues/237)
* get the correct boolean value of the input ([#233](https://github.com/googleapis/release-please-action/issues/233)) ([c23605f](https://github.com/googleapis/release-please-action/commit/c23605fcb2b0807911f30bf19060ddeda84e105a))
* **go:** filter additional PRs from gapic repo ([#145](https://github.com/googleapis/release-please-action/issues/145)) ([b02ff3b](https://github.com/googleapis/release-please-action/commit/b02ff3b568326db3e85a5249ae37e33c39dd4563))
* **go:** first commit sha was not being stored ([b555656](https://github.com/googleapis/release-please-action/commit/b5556569e8852edb74aadc6aff8bd9315d600689))
* **go:** non-gapic/apiary libraries now bump patch ([#150](https://github.com/googleapis/release-please-action/issues/150)) ([00fefb4](https://github.com/googleapis/release-please-action/commit/00fefb4ff917a53cb65ed27c14c0586ef9055b37))
* **go:** pass monorepoTags when opening PR ([#142](https://github.com/googleapis/release-please-action/issues/142)) ([3428252](https://github.com/googleapis/release-please-action/commit/34282521f08daa0962fba0a8d98936286a0b2896))
* **go:** pass release-type ([#160](https://github.com/googleapis/release-please-action/issues/160)) ([5c5271c](https://github.com/googleapis/release-please-action/commit/5c5271ce75fb1e7955fddc806b9260163206aa27))
* **input:** miss inputs config for action.yml ([#376](https://github.com/googleapis/release-please-action/issues/376)) ([c7c1147](https://github.com/googleapis/release-please-action/commit/c7c114719ac3d17225d5f4b0999e80bad98d4621))
...
* **manifest:** if "." is used it should have same outputs as node ([#319](https://github.com/googleapis/release-please-action/issues/319)) ([d234c63](https://github.com/googleapis/release-please-action/commit/d234c634c289f2e3fe4398b9fe234dadaa2fb486))
* **pagination:** tagging can use 'updated' releases should use 'created' ([b5e370c](https://github.com/googleapis/release-please-action/commit/b5e370ce70ebd5db6cffa9e93327c62dbd29ffde))
* parse false value for clean ([fc5b3e5](https://github.com/googleapis/release-please-action/commit/fc5b3e5c11baace865aed65127f107a4d8b392da))
...
* README.md typos ([#186](https://github.com/googleapis/release-please-action/issues/186)) ([e363460](https://github.com/googleapis/release-please-action/commit/e36346079c94b226b38a19d018ca6cdc044080e0))
* **release-please:** buf fixes for pre-release versions ([#334](https://github.com/googleapis/release-please-action/issues/334)) ([d7f1090](https://github.com/googleapis/release-please-action/commit/d7f1090a7d15d4d583ae88a9c15b29aef294d022))
* **release-please:** don't add labels from fork ([13bffc3](https://github.com/googleapis/release-please-action/commit/13bffc3e974a8edf5d4830257a17d40e9cb9a32f))
* **release-please:** fallback to tag ([#89](https://github.com/googleapis/release-please-action/issues/89)) ([c6f1cd6](https://github.com/googleapis/release-please-action/commit/c6f1cd680fabd9729dc13f6bde59ed5160acb9a3))
* **release-please:** fix for merge commits ([#126](https://github.com/googleapis/release-please-action/issues/126)) ([35f9456](https://github.com/googleapis/release-please-action/commit/35f94566f5857aafe9fdaad7b2e7df122aac5a92))
* **release-please:** fix whitespace issues in Rust ([#195](https://github.com/googleapis/release-please-action/issues/195)) ([b5e370c](https://github.com/googleapis/release-please-action/commit/b5e370ce70ebd5db6cffa9e93327c62dbd29ffde))
* **release-please:** fixed branch detection logic for ruby ([#139](https://github.com/googleapis/release-please-action/issues/139)) ([cd052f4](https://github.com/googleapis/release-please-action/commit/cd052f41cb6dce082f59e9edad966004813dcdc5))
* **release-please:** fixed bug with "." releaser ([#283](https://github.com/googleapis/release-please-action/issues/283)) ([fe52822](https://github.com/googleapis/release-please-action/commit/fe5282250cf3f28e6d85435afa452b663d02002b))
* **release-please:** fixes for monorepo path handling ([#181](https://github.com/googleapis/release-please-action/issues/181)) ([349920d](https://github.com/googleapis/release-please-action/commit/349920da705ae2434e49ea95bd1c90238b71aafa))
* **release-please:** handle missing packageName release-pr ([#184](https://github.com/googleapis/release-please-action/issues/184)) ([88127ca](https://github.com/googleapis/release-please-action/commit/88127ca26bc402aaf2d7e9f2182035ad2e81b417))
...
* **release-please:** increase page size for release PRs ([#187](https://github.com/googleapis/release-please-action/issues/187)) ([abdb363](https://github.com/googleapis/release-please-action/commit/abdb3633221dfc822423679ad246db4e1b048fff))
* **release-please:** last release had undefined ordering behavior ([a4b349d](https://github.com/googleapis/release-please-action/commit/a4b349d8a8462722f0d1c246581650a4788b76ee))
* **release-please:** map go to alternate tag separator ([#157](https://github.com/googleapis/release-please-action/issues/157)) ([bdc110f](https://github.com/googleapis/release-please-action/commit/bdc110f19e7d011ed957f41b21f69b3005d151c1))
* **release-please:** missing js-yaml dependency ([#254](https://github.com/googleapis/release-please-action/issues/254)) ([faf27ee](https://github.com/googleapis/release-please-action/commit/faf27eea7cfff4bb3dfe752f4f87c8e0b6e07378))
* **release-please:** paginate PRs by updated ([#192](https://github.com/googleapis/release-please-action/issues/192)) ([92f9818](https://github.com/googleapis/release-please-action/commit/92f9818112ba7b24ebe9629d519b12e93df6a0ab))
...
* **release-please:** release please with code-suggester bug fixes ([#66](https://github.com/googleapis/release-please-action/issues/66)) ([6b79987](https://github.com/googleapis/release-please-action/commit/6b79987e9000e7617d81e9645c8394f27b396a8d))
* **release-please:** setup.py retains formatting ([#246](https://github.com/googleapis/release-please-action/issues/246)) ([038a2f3](https://github.com/googleapis/release-please-action/commit/038a2f320b92c8a4009d3fe7261fc34c6070b446))
* **release-please:** sort commits ([#82](https://github.com/googleapis/release-please-action/issues/82)) ([846f33a](https://github.com/googleapis/release-please-action/commit/846f33aee4836826ed78a893aa7c1bbd46da6bd4))
* **release-please:** stop dynamically loading releasers ([#165](https://github.com/googleapis/release-please-action/issues/165)) ([4de8d4a](https://github.com/googleapis/release-please-action/commit/4de8d4ac44ed9d0a8d20386d68169b86b30d798a))
* **release-please:** update github-release call to new function ([#217](https://github.com/googleapis/release-please-action/issues/217)) ([efd1c77](https://github.com/googleapis/release-please-action/commit/efd1c77e85e3e407ac71c4eb338fc1aa86027455))
* **release-please:** update to release-please@11.8.1 ([#293](https://github.com/googleapis/release-please-action/issues/293)) ([4d8569b](https://github.com/googleapis/release-please-action/commit/4d8569bf77ccda4bebb9dd136251a08079b409c4))
...
* **release-please:** uses alternate approach to find files in repo ([#198](https://github.com/googleapis/release-please-action/issues/198)) ([c540b9e](https://github.com/googleapis/release-please-action/commit/c540b9e79be1b629a02e961a539eea29c1e9e57a))
* **release-please:** uses factory from latest version ([#222](https://github.com/googleapis/release-please-action/issues/222)) ([cede8e4](https://github.com/googleapis/release-please-action/commit/cede8e48374038ce478d27a172085187b4668923))
* **relese-please:** rollback bad release ([#338](https://github.com/googleapis/release-please-action/issues/338)) ([68f6fc6](https://github.com/googleapis/release-please-action/commit/68f6fc67aa29c63452a09eba621445ce2c6dfcb7))
...
* **ruby:** properly support ruby release process ([#92](https://github.com/googleapis/release-please-action/issues/92)) ([6c289af](https://github.com/googleapis/release-please-action/commit/6c289af7b611b6019c67c2285397d905380962ac))
...
* support alternate CHANGELOG.md path ([#329](https://github.com/googleapis/release-please-action/issues/329)) ([3e6dc1e](https://github.com/googleapis/release-please-action/commit/3e6dc1e3aa39466a14ad5275b71e68b636f49285))
